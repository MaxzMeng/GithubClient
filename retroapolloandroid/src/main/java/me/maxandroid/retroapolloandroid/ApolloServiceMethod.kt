package me.maxandroid.retroapolloandroid

import com.apollographql.apollo.api.Query
import me.maxandroid.retroapolloandroid.annotations.GraphQLQuery
import me.maxandroid.retroapolloandroid.utils.Utils
import me.maxandroid.retroapolloandroid.utils.error
...
class ApolloServiceMethod<T : Any>(
    ...
    class Builder(private val retroApollo: RetroApollo, val method: Method) {
        ...
        fun build() =
            ApolloServiceMethod(retroApollo, method, buildBuilderMethod, buildQueryMethod, fieldSetters, callAdapter)
